  ...
  head: () => ({
    meta: [
      ...
      },
      {
        ...
        content:
          "Curated electronics, health, kitchen, home, fashion and furniture picks. Updated weekly by the BigCart team.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "BigCart",
          email: "bigcartng@gmail.com",
          sameAs: ["https://instagram.com/bigcartuk"],
        }),
      },
    ],
  }),
